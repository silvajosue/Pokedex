...
public class PokedexApplication {
	...
	CommandLineRunner init(ReactiveMongoOperations operations, PokemonRepository repository) {
		return args -> {
			Flux<Pokemon> pokemonFlux = Flux.just(new Pokemon(null, "Blastoise", "Marisco", "Torrente", 9.0),
					new Pokemon(null, "Caterpie", "Minhoca", "Poeira de excuto", 2.08),
					new Pokemon(null, "Bulbassauro", "Semente", "Grandeza", 10.00)).flatMap(repository::save);
